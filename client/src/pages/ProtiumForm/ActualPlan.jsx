      ...
      {isOpen && (
        <div className="p-3 border rounded mt-2 bg-gray-50">
          <form>
            ...
            <h5 className="mt-4 mb-3 text-lg font-semibold">Market Value of Property as per Actual</h5>
            <div className="flex flex-wrap mb-3 -mx-2">
              <div className="w-full md:w-1/2 px-2 mb-3">
            ...
            <h5 className="mt-4 mb-3 text-lg font-semibold">Govt. Guideline Value</h5>
            <div className="flex flex-wrap mb-3 -mx-2">
            ...
            <h5 className="mt-4 mb-3 text-lg font-semibold">Floorwise Details</h5>
            ...
            <div className="mb-3">
              <div className="w-full px-2 mb-3">
                <label className="block mb-1">Risk regarding seismic zone, cyclone area, flood area, land slide:</label>
                <input
                  type="text"
                  name="riskAssessment"
                  className="w-full p-2 border rounded"
            ...
            <h5 className="mt-4 mb-3 text-lg font-semibold">Additional Information</h5>
            <div className="flex flex-wrap mb-3 -mx-2">
              <div className="w-full md:w-1/2 px-2 mb-3">
