...
const LocationDetails = ({ onNext }) => {
  const [isOpen, setIsOpen] = useState(true);

  const [formData, setFormData] = useState({
    propertyAddressTRF: "PROPERTY IS PLOT NO.05(PART-1)...",
    propertyAddressVisit: "PROPERTY IS PLOT NO.05(PART-1)...",
    propertyAddressDocs: "PROPERTY IS PLOT NO.05(PART-1)...",
    mainLocality: "MISROD",
