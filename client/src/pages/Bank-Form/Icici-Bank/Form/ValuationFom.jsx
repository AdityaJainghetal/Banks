    ...
    <div className="w-full ">
      ...
      {isEditOpen && (
        <form onSubmit={handleSubmit} className="mt-4 space-y-6">
          <div className="mb-4">
            <label className="block font-bold mb-2">Valuation Methodology</label>
            <select 
          ...
          <Card title="Valuation As Per Government Rates" className="w-full">
            <div className="mb-4">
              <Radio.Group className="mb-4">
                ...
                <Radio value="residential" defaultChecked>Residential</Radio>
              </Radio.Group>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border p-2">
                        <Input
                          type="number"
                          value={formData.governmentRatesData.constructionArea}
                          onChange={handleGovRatesChange}
                      ...
                      <td className="border p-2">
                        <Input
                          type="number"
                          value={formData.governmentRatesData.constructionRate}
                          onChange={handleGovRatesChange}
