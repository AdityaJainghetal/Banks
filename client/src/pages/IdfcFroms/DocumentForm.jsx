    ...
    <div className="p-3 bg-orange-50 border border-gray-300 rounded-lg">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-1">Req Initiator Name / CPC Code</label>
            <input
              type="text"
          ...
          {formData.locations.map((location, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 mb-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Distance from office (km)</label>
                  <input
                    type="number"
                    step="0.1"
