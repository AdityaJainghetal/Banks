...
const PropertyAndUnitDetailsForm = ({ onNext }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    virtualVisit: false, // Changed to Boolean
    plotDemarcatedAtSite: 'YES',
    commercializedArea: false, // Changed to Boolean
    classOfLocality: 'REPEAL CLASS HERE',
    distanceFromCityCenter: '',
    noOfFloors: '1',
    toBeBilled: false, // Changed to Boolean
    greenHousing: false, // Changed to Boolean
